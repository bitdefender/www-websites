...
- ✅ Sharp image library is installed (`cd .github/skills/scrape-webpage/scripts && npm install`)
...
**Command:**
```bash
node .github/skills/scrape-webpage/scripts/analyze-webpage.js "https://example.com/page" --output ./import-work
```
...
**Sharp not installed:**
```bash
cd .github/skills/scrape-webpage/scripts && npm install
```
