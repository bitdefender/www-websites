...
```bash
node .github/skills/docs-search/scripts/search.js [--all] <keyword1> [keyword2] [...]
```
...
node .github/skills/docs-search/scripts/search.js block decoration

# Search for metadata with all results
node .github/skills/docs-search/scripts/search.js --all metadata

# Multi-word search
node .github/skills/docs-search/scripts/search.js universal editor blocks
```
...
Index files are cached locally for 24 hours in `.github/skills/docs-search/.cache/`. This speeds up subsequent searches.
...
**Good Approach:**
1. Search: `node .github/skills/docs-search/scripts/search.js block decoration`
...
**Good Approach:**
1. Search: `node .github/skills/docs-search/scripts/search.js metadata`
